...
namespace PruebaCorta2.Views
{
    ...
    {
        // Clase que representa una página web ASP.NET para cargar y mostrar los datos de los resorts
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                // Se obtiene una lista de todos los resorts de la base de datos
